...
- [x] Comprendre la différence entre `git reset` et `git revert`(git reset pour daplacer la branche sur un commit specifique et qui revert pour annuler les modification d'un commit)
